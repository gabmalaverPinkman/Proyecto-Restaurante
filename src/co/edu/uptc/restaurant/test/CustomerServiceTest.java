...
class CustomerServiceTest {
    ...
    private Customer crearClienteValido() {
        return new Customer("Santiago", "Borda", 12345678, null, 3);
    }
    ...
    void updateCustomer_existente_retornaExito() {
        customerService.addCustomer(crearClienteValido());
        Customer actualizado = new Customer("Santiago Actualizado", "Borda", 12345678, null, 5);
    ...
    void updateCustomer_datosInvalidos_retornaFallo() {
        customerService.addCustomer(crearClienteValido());
        Customer invalido = new Customer("", "Borda", 12345678, null, 5);
